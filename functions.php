...
// -------------------------------------------------------
// Meta Pixel Facebook (ID : 952494574054153)
// -------------------------------------------------------
function ads_meta_pixel() {
    ?>
    <!-- Meta Pixel Code -->
    <script>
    ...
    fbq('init', '952494574054153');
    fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=952494574054153&ev=PageView&noscript=1"
    /></noscript>
    <!-- End Meta Pixel Code -->
    <?php
}
add_action( 'wp_head', 'ads_meta_pixel' );
