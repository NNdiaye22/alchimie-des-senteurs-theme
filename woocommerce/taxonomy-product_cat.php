...
$default_ed_lbl = ads_s( 'ads_cat_default_ed_label', 'La selection' );
$default_ed_txt = ads_s( 'ads_cat_default_ed_text',  '&laquo; Chaque forme, une experience olfactive unique. &raquo;' );
...
<div class="shop-wrap cat-wrap cat-<?php echo esc_attr($slug); ?>">
  ...
  >
    ...
    <div class="shop-hero-count">
      ...
      <div class="shop-hero-count-label">Reference<?php echo $count > 1 ? 's' : ''; ?></div>
    </div>
    <?php endif; ?>
  </div>
  ...
  <div class="shop-grid-wrap">
        ...
        <div class="shop-card-img">
          ...
          <div class="shop-card-overlay">
            <a class="shop-card-quick"
               ...
               onclick="event.stopPropagation()">Decouvrir</a>
          </div>
        </div>
    ...
    <div class="shop-grid">
      <div class="shop-empty">
        <p>Aucun produit dans cette categorie pour le moment.</p>
      </div>
    </div>
    <?php endif; ?>
  </div>
